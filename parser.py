...
def parse_amazon_meta_fast(filepath, dbpath="amazon_fast.db", limite=None, flush_every=1000):
...
if __name__ == "__main__":
    INPUT_GZ = "amazon-meta (1).txt.gz"
    DB_PATH = "amazon_fast.db"
    LIMITE = None     # definir para testes rápidos
    FLUSH_EVERY = 1000
    parse_amazon_meta_fast(INPUT_GZ, dbpath=DB_PATH, limite=LIMITE, flush_every=FLUSH_EVERY)
